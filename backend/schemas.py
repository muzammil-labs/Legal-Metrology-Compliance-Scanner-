...
class PDPFontEvaluation(BaseModel):
    estimated_pdp_area_sq_cm: float
    mandatory_min_font_height_mm: float
    measured_font_height_mm: float
    font_size_compliance: RuleStatus
    statutory_clause: str = "Rule 5 & Schedule II (Minimum Font Height)"
    details: str
